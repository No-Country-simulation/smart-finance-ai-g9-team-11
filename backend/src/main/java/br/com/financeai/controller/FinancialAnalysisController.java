...
public class FinancialAnalysisController {
    ...
    @Operation(
            ...
            description = """
                Returns the complete history of financial analyses
                generated by the authenticated user.
                """
    )
    @ApiResponses({
            @ApiResponse(
    ...
    @Operation(
            ...
            description = """
                Returns a specific financial analysis
