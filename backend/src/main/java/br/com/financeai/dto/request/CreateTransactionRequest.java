...
/**
 * Dados recebidos para criação de uma nova transação.
 *
 * A categoria não é enviada pelo frontend neste momento,
 * pois será definida pelo serviço de classificação.
 */
