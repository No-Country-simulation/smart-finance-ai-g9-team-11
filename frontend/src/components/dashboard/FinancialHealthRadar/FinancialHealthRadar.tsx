...
} from "./FinancialHealthRadarTooltip";
...
export function FinancialHealthRadar({
  title =
    "Quão saudável está sua vida financeira?",
  description =
    "Indicadores derivados da sua análise financeira.",
  ...
  useEffect(() => {
    ...
    const currentMetricStillExists =
      metrics.some(
        (metric) =>
          metric.id ===
          activeMetricId,
        ...
        activeMetric ? (
          ...
          >
            ...
            <p className="mt-1 max-w-sm text-xs leading-5 text-text-muted">
              Os indicadores de saúde financeira serão exibidos quando uma análise estiver disponível.
            </p>
